class Escenario {
  ...
  void encender() {
    ...
    if( fade == 0 ){
      ...
      Objeto o2 = new Objeto( 400, 0, 0.3, 102, 60, true, "peceschicos", 1, 0, 0, 0 );
      objetos = (Objeto[]) append(objetos, o2);
      Objeto o3 = new Objeto( -500, -100, 0.3, 205, 120, true, "peces", 1, 0, 0, 0 );
      objetos = (Objeto[]) append(objetos, o3);
      Objeto o4 = new Objeto( 900, 200, 0.6, 168, 246, true, "hueco", 1, 0, 0, 0 );
      objetos = (Objeto[]) append(objetos, o4);
      Objeto o5 = new Objeto( 300, 180, 0.8, 456, 480, true, "puerta", 1, 0, 0, 0 );
      objetos = (Objeto[]) append(objetos, o5);
      Objeto o6 = new Objeto( -1024, 300, 0.9, 273, 98, true, "flor", 1, 0, 0, 0 );
